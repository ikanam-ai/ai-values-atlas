...
Browse all 1013 resources on the [interactive atlas](https://ikanam-ai.github.io/ai-values-atlas/),
...
| ⚖️ Conflict choice | Which value wins when motivations conflict? | forced choice, ranking, paired alternatives | choice priority under the task contract |
| ✍️ Generated framing | Which values are expressed in open text? | free generation followed by mapping or scoring | textual-framing profile |
...
> ⭐ journal, conference, or workshop venue listed · 📄 preprint or venue not verified.
> These markers follow catalog metadata; they are not an independent peer-review audit.
